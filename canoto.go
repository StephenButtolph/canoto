...
func (s *Spec) marshal(w Writer, a Any, specs *Stack[*Spec]) (Writer, error) {
	specs = &Stack[*Spec]{
		Value:    s,
		Previous: specs,
	}
...
func (f *FieldType) marshal(w Writer, value any, specs *Stack[*Spec]) (Writer, error) {
	var marshal func(f *FieldType, w Writer, value any, specs *Stack[*Spec]) (Writer, error)
	switch f.CachedWhichOneOfType() {
	case 6:
...
func (f *FieldType) marshalInt(w Writer, value any, _ *Stack[*Spec]) (Writer, error) {
...
func (f *FieldType) marshalUint(w Writer, value any, _ *Stack[*Spec]) (Writer, error) {
	return marshalPacked(
		f,
		w,
		value,
...
func (f *FieldType) marshalFixedInt(w Writer, value any, _ *Stack[*Spec]) (Writer, error) {
	return marshalPacked(
		f,
		w,
		value,
...
func (f *FieldType) marshalFixedUint(w Writer, value any, _ *Stack[*Spec]) (Writer, error) {
	return marshalPacked(
		f,
		w,
		value,
...
func (f *FieldType) marshalBool(w Writer, value any, _ *Stack[*Spec]) (Writer, error) {
	return marshalPacked(
		f,
		w,
		value,
...
func (f *FieldType) marshalString(w Writer, value any, _ *Stack[*Spec]) (Writer, error) {
...
func (f *FieldType) marshalBytes(w Writer, value any, _ *Stack[*Spec]) (Writer, error) {
	return marshalUnpacked(
		f,
		w,
		value,
...
func (f *FieldType) marshalSpec(w Writer, value any, specs *Stack[*Spec]) (Writer, error) {
	return marshalUnpacked(
		f,
		w,
		value,
