...
type SpecFuzzer struct {
	...
	CustomUint32               customUint32                          `canoto:"fint32,66"               json:"CustomUint32,omitempty"`
	CustomString               customString                          `canoto:"string,67"               json:"CustomString,omitempty"`
	CustomBytes                customBytes                           `canoto:"bytes,68"                json:"CustomBytes,omitempty"`
	CustomRepeatedBytes        customRepeatedBytes                   `canoto:"repeated bytes,70"       json:"CustomRepeatedBytes,omitempty"`
