...
`,
			repeated: `			${selector}FieldTypeFrom${suffix}(
				/*type:       */ ${selector}MakeEntry(zero.${fieldName}),
				/*FieldNumber:*/ ${fieldNumber},
				/*Name:       */ "${fieldName}",
				/*FixedLength:*/ 0,
				/*Repeated:   */ true,
...
`,
		values: typeTemplate{
			single: `			${selector}FieldTypeFromField(
				/*type:       */ ${genericTypeCast}(&zero.${fieldName}),
				/*FieldNumber:*/ ${fieldNumber},
				/*Name:       */ "${fieldName}",
				/*FixedLength:*/ 0,
				/*Repeated:   */ false,
...
`,
			repeated: `			${selector}FieldTypeFromField(
				/*type:       */ ${genericTypeCast}(${selector}MakeEntryPointer(zero.${fieldName})),
				/*FieldNumber:*/ ${fieldNumber},
				/*Name:       */ "${fieldName}",
				/*FixedLength:*/ 0,
				/*Repeated:   */ true,
...
`,
			repeated: `			${selector}FieldTypeFromField(
				/*type:       */ ${genericTypeCast}(${selector}MakeEntry(zero.${fieldName})),
				/*FieldNumber:*/ ${fieldNumber},
				/*Name:       */ "${fieldName}",
				/*FixedLength:*/ 0,
				/*Repeated:   */ true,
